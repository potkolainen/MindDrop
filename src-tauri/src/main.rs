...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::open_assistive_search_window,
            commands::open_search_window,
            commands::extract_page_content,
            commands::close_search_window,
            commands::send_page_to_chat,
            commands::check_diffuser_backends,
            commands::install_diffuser_backend,
            commands::uninstall_diffuser_backend,
